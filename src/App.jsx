...
function Logo({ compact = false, dark = false }) {
  ...
  return (
    <Link to="/" className="flex items-center gap-3" aria-label="Pathways Academy logo">
...
function SiteHeader({ openApplicationForm }) {
    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <nav className="hidden items-center gap-7 text-sm text-slate-300 lg:flex">
          ...
          <Link to="/visa-residence-permit" className="transition hover:text-white">Visa Guide</Link>
          <Link to="/student-finance" className="transition hover:text-white">Student Finance</Link>
          <Link to="/living-in-netherlands" className="transition hover:text-white">Living in NL</Link>
        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-3 text-sm text-slate-300">
              <Link to="/" className="text-left hover:text-white">Home</Link>
              ...
              <Link to="/visa-residence-permit" className="text-left hover:text-white">Visa & Residence Permit</Link>
              <Link to="/student-finance" className="text-left hover:text-white">Student Finance</Link>
              <Link to="/living-in-netherlands" className="text-left hover:text-white">Living in the Netherlands</Link>
            </div>
          </div>
        </div>
...
function HomePage({ openApplicationForm }) {
  ...
  return (
    <>
      <main>
        ...
        <section id="student-life" className="bg-white px-6 py-24 text-slate-950">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-3xl text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#E86233]">Student Life & Practical Support</p>
              <h2 className="mt-4 text-4xl font-semibold tracking-tight md:text-5xl">Prepare for studying, living, and arriving in the Netherlands.</h2>
            ...
            <div className="mt-14 grid gap-6 lg:grid-cols-3">
              <Link to="/visa-residence-permit" className="rounded-3xl bg-slate-100 p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                <h3 className="text-2xl font-semibold text-slate-950">Visa & Residence Permit</h3>
                <p className="mt-4 leading-7 text-slate-700">
                  Understand the Dutch student visa process, MVV guidance, residence permit preparation, and required documents.
                </p>
                <p className="mt-6 font-semibold text-[#E86233]">Read More →</p>
              </Link>

              <Link to="/student-finance" className="rounded-3xl bg-slate-100 p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                <h3 className="text-2xl font-semibold text-slate-950">Student Finance</h3>
                <p className="mt-4 leading-7 text-slate-700">
                  Learn about tuition payments, monthly living costs, budgeting, scholarships, and financial planning.
                </p>
                <p className="mt-6 font-semibold text-[#E86233]">Read More →</p>
              </Link>

              <Link to="/living-in-netherlands" className="rounded-3xl bg-slate-100 p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                <h3 className="text-2xl font-semibold text-slate-950">Living in the Netherlands</h3>
                <p className="mt-4 leading-7 text-slate-700">
                  Prepare for housing, travel, municipality registration, insurance, transport, and student life.
                </p>
                <p className="mt-6 font-semibold text-[#E86233]">Read More →</p>
              </Link>
            </div>
    ...
    <main className="bg-white px-6 py-24 text-slate-950">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-8 text-lg leading-8 text-slate-700">
          International students planning to study in the Netherlands may need a student visa, known as an MVV, and a residence permit. Requirements depend on nationality, study duration, programme type, and official Dutch immigration rules.
        </p>

        <div className="mt-12 space-y-8">
          <div className="rounded-3xl bg-slate-100 p-8">
            <h2 className="text-2xl font-semibold">What students should prepare</h2>
            <ul className="mt-6 space-y-3 text-slate-700">
              <li>✓ Valid passport</li>
              <li>✓ Admission or conditional offer letter</li>
              <li>✓ Proof of sufficient financial means</li>
              <li>✓ Tuition payment or deposit confirmation when required</li>
              <li>✓ Academic documents and translations if needed</li>
              <li>✓ Health insurance planning</li>
              <li>✓ Completed visa and residence-permit forms when required</li>
            </ul>
          </div>

          <div className="rounded-3xl bg-slate-100 p-8">
            <h2 className="text-2xl font-semibold">Typical process</h2>
            <ol className="mt-6 space-y-3 text-slate-700">
              <li>1. Receive admission or conditional admission.</li>
              <li>2. Prepare financial and academic documentation.</li>
              <li>3. Submit visa and residence-permit documents through the required process.</li>
              <li>4. Complete embassy or biometric appointment steps if applicable.</li>
              <li>5. Wait for the official decision.</li>
              <li>6. Travel to the Netherlands and complete arrival registration.</li>
            </ol>
          </div>

          <div className="rounded-3xl border border-[#F97343]/30 bg-[#F97343]/10 p-8">
            <h2 className="text-2xl font-semibold">Important note</h2>
            <p className="mt-4 leading-7 text-slate-700">
              Visa and residence-permit rules can change. Pathways Academy supports students with preparation and guidance, but final immigration decisions are made by the relevant Dutch authorities.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <main className="bg-white px-6 py-24 text-slate-950">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-8 text-lg leading-8 text-slate-700">
          Students should prepare carefully for tuition fees, accommodation, insurance, transport, food, study materials, and personal expenses before arriving in the Netherlands.
        </p>

        <div className="mt-12 grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl bg-slate-100 p-8">
            <h2 className="text-2xl font-semibold">Estimated monthly costs</h2>
            <ul className="mt-6 space-y-3 text-slate-700">
              <li>Accommodation: €500–€1,200</li>
              <li>Food and groceries: €200–€350</li>
              <li>Insurance: €100–€150</li>
              <li>Transport: €50–€100</li>
              <li>Personal expenses: varies by lifestyle</li>
            </ul>
          </div>

          <div className="rounded-3xl bg-slate-100 p-8">
            <h2 className="text-2xl font-semibold">Financial planning support</h2>
            <ul className="mt-6 space-y-3 text-slate-700">
              <li>✓ Tuition fee planning</li>
              <li>✓ Proof of financial means guidance</li>
              <li>✓ Living cost estimation</li>
              <li>✓ Scholarship information where available</li>
              <li>✓ Health insurance preparation</li>
              <li>✓ Student budget planning</li>
            </ul>
          </div>
        </div>

        <div className="mt-8 rounded-3xl border border-[#F97343]/30 bg-[#F97343]/10 p-8">
          <h2 className="text-2xl font-semibold">Our advice</h2>
          <p className="mt-4 leading-7 text-slate-700">
            Students should not only calculate tuition fees, but also prepare a realistic monthly budget for housing, transport, food, insurance, and emergency costs.
          </p>
        </div>
      </div>
    </main>
  ...
  return (
    <main className="bg-white px-6 py-24 text-slate-950">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-8 text-lg leading-8 text-slate-700">
          International students should prepare for accommodation, insurance, municipality registration, transportation, student life, and practical arrival steps before starting their studies.
        </p>
        ...
        <div className="mt-12 space-y-6">
          <div className="rounded-3xl bg-slate-100 p-8">
            ...
            <p className="mt-4 leading-7 text-slate-700">
              Students can explore university housing, shared apartments, student residences, or private rentals. Housing should be arranged early because student accommodation can be competitive.
            </p>
          </div>

          <div className="rounded-3xl bg-slate-100 p-8">
            <h2 className="text-2xl font-semibold">BSN and municipality registration</h2>
            <p className="mt-4 leading-7 text-slate-700">
              After arrival, students usually register with the municipality and receive a BSN number. This number is important for official services, banking, work, insurance, and government communication.
            </p>
          </div>

          <div className="rounded-3xl bg-slate-100 p-8">
            <h2 className="text-2xl font-semibold">Insurance and daily life</h2>
            <p className="mt-4 leading-7 text-slate-700">
              Students should understand health insurance requirements, transport options, local rules, emergency contacts, banking, and practical student life expectations before arrival.
            </p>
          </div>
        </div>
      </div>
